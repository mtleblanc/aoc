...
template <> struct SolutionType<2017, 07>
{
    using type = StringSolution;
};

template <> struct SolutionType<2017, 10>
{
    using type = StringSolution;
};

template <> struct SolutionType<2017, 16>
{
    using type = StringSolution;
};

template <> struct SolutionType<2017, 19>
{
    using type = StringSolution;
};

template <> struct SolutionType<2018, 2>
{
    using type = StringSolution;
};

template <> struct SolutionType<2018, 7>
{
    using type = StringSolution;
};

template <> struct SolutionType<2018, 9>
{
    using type = LongSolution;
};
...
template <> struct SolutionType<2018, 11>
{
    using type = StringSolution;
};

template <> struct SolutionType<2018, 12>
{
    using type = LongSolution;
};

template <> struct SolutionType<2018, 13>
{
    using type = StringSolution;
};

template <> struct SolutionType<2018, 14>
{
    using type = LongSolution;
};
...
template <> Solution_t<2017, 1> solve<2017, 1>(std::istream& input);
template <> Solution_t<2017, 2> solve<2017, 2>(std::istream& input);
template <> Solution_t<2017, 3> solve<2017, 3>(std::istream& input);
template <> Solution_t<2017, 4> solve<2017, 4>(std::istream& input);
template <> Solution_t<2017, 5> solve<2017, 5>(std::istream& input);
template <> Solution_t<2017, 6> solve<2017, 6>(std::istream& input);
template <> Solution_t<2017, 7> solve<2017, 7>(std::istream& input);
template <> Solution_t<2017, 8> solve<2017, 8>(std::istream& input);
template <> Solution_t<2017, 9> solve<2017, 9>(std::istream& input);
template <> Solution_t<2017, 10> solve<2017, 10>(std::istream& input);
template <> Solution_t<2017, 11> solve<2017, 11>(std::istream& input);
template <> Solution_t<2017, 12> solve<2017, 12>(std::istream& input);
template <> Solution_t<2017, 13> solve<2017, 13>(std::istream& input);
template <> Solution_t<2017, 14> solve<2017, 14>(std::istream& input);
template <> Solution_t<2017, 15> solve<2017, 15>(std::istream& input);
template <> Solution_t<2017, 16> solve<2017, 16>(std::istream& input);
template <> Solution_t<2017, 17> solve<2017, 17>(std::istream& input);
template <> Solution_t<2017, 18> solve<2017, 18>(std::istream& input);
template <> Solution_t<2017, 19> solve<2017, 19>(std::istream& input);
template <> Solution_t<2017, 20> solve<2017, 20>(std::istream& input);
template <> Solution_t<2017, 21> solve<2017, 21>(std::istream& input);
template <> Solution_t<2017, 22> solve<2017, 22>(std::istream& input);
template <> Solution_t<2017, 23> solve<2017, 23>(std::istream& input);
template <> Solution_t<2017, 24> solve<2017, 24>(std::istream& input);
template <> Solution_t<2017, 25> solve<2017, 25>(std::istream& input);

template <> Solution_t<2018, 1> solve<2018, 1>(std::istream& input);
template <> Solution_t<2018, 2> solve<2018, 2>(std::istream& input);
template <> Solution_t<2018, 3> solve<2018, 3>(std::istream& input);
template <> Solution_t<2018, 4> solve<2018, 4>(std::istream& input);
template <> Solution_t<2018, 5> solve<2018, 5>(std::istream& input);
template <> Solution_t<2018, 6> solve<2018, 6>(std::istream& input);
template <> Solution_t<2018, 7> solve<2018, 7>(std::istream& input);
template <> Solution_t<2018, 8> solve<2018, 8>(std::istream& input);
template <> Solution_t<2018, 9> solve<2018, 9>(std::istream& input);
template <> Solution_t<2018, 10> solve<2018, 10>(std::istream& input);
template <> Solution_t<2018, 11> solve<2018, 11>(std::istream& input);
template <> Solution_t<2018, 12> solve<2018, 12>(std::istream& input);
template <> Solution_t<2018, 13> solve<2018, 13>(std::istream& input);
template <> Solution_t<2018, 14> solve<2018, 14>(std::istream& input);
template <> Solution_t<2018, 15> solve<2018, 15>(std::istream& input);
template <> Solution_t<2018, 16> solve<2018, 16>(std::istream& input);
template <> Solution_t<2018, 17> solve<2018, 17>(std::istream& input);
template <> Solution_t<2018, 18> solve<2018, 18>(std::istream& input);
template <> Solution_t<2018, 19> solve<2018, 19>(std::istream& input);
template <> Solution_t<2018, 20> solve<2018, 20>(std::istream& input);
template <> Solution_t<2018, 21> solve<2018, 21>(std::istream& input);
template <> Solution_t<2018, 22> solve<2018, 22>(std::istream& input);
template <> Solution_t<2018, 23> solve<2018, 23>(std::istream& input);
template <> Solution_t<2018, 24> solve<2018, 24>(std::istream& input);
template <> Solution_t<2018, 25> solve<2018, 25>(std::istream& input);
